...
export default function IndeterminateCheckbox() {
  ...
  return (
    <div>
      ...
      <FormControlLabel
        label="Pads"
        control={<Checkbox checked={checked[0]} onChange={handleChangePads} />}
      />
      <FormControlLabel
        label="Tampons"
        control={<Checkbox checked={checked[1]} onChange={handleChangeTampons} />}
      />
      <FormControlLabel
        label="Menstrual cups"
        control={<Checkbox checked={checked[2]} onChange={handleChangeMenstrualCup} />}
      />
      <FormControlLabel
        label="Prefer not to answer"
        control={<Checkbox checked={checked[3]} onChange={handleChangeNoAnswer} />}
      />
    </Box>
    </div>
  );
